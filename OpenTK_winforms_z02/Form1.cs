...
namespace OpenTK_winforms_z02
{
    public partial class Form1 : Form
    {
        ...
        private void btnMyLight_Click(object sender, EventArgs e)
        {
            if(punct.getLight()) btnMyLight.Text = "My Light OFF"; else btnMyLight.Text = "My Light ON";
            punct.onLight();
            GlControl1.Invalidate();
        }
